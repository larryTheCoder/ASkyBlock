...
public class Settings {
    ...
    public static List<ItemPotion> acidDamageType = new ArrayList<>();
    ...
    // Levels
    public static HashMap<Item, Integer> blockLimits;
    public static HashMap<Item, Integer> blockValues;
    ...
    public static Entity islandCompanion;
    ...
    public static List<Entity> mobWhiteList = new ArrayList<>();
